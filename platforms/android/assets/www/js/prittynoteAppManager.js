...
var prittyNote = {
    ...
    drawCanvas: function(text) {
        ...
        if(image) {
            ...
            imageObj.onload = function() {
                context.drawImage(imageObj, image.x1, image.y1, image.x2, image.y2);
    ...
    downloadPrittyNote: function() {
        ...
        prittyNote.download.fromJava(myBase64);
    ...
    download: {
        fromJava: function(myBase64) {
            ...
            window.plugins.base64ToPNG.saveImage(myBase64,
                {filename:"PrittyNote", overwrite: true, folder: "PrittyNote", shareThis: prittyNote.share},
                function(result) {
...
(function ($) {
    ...
    loadUtilities = function(el) {
        ...
        var defaults = {
            fileorurl: './js/stickinoteUtilitiesPRO.json',
            script:  {
